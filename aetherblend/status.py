...
class AetherBlendStatus:
    ...
    def get_meddle_status():
        ...
        return (AetherBlendStatus.meddle_installed and AetherBlendStatus.meddle_is_latest and AetherBlendStatus.meddle_enabled and not AetherBlendStatus.get_prompt_user_meddle())

    @staticmethod
    def get_aetherblend_status():
        """Reads if AetherBlend is installed and up-to-date."""
        return (AetherBlendStatus.is_branch and AetherBlendStatus.is_latest and not AetherBlendStatus.get_prompt_user_aether())
