...
UI_PLAYER_SFW = {
                ...
                "FFXIV": BoneCollection(name="FFXIV", ui=True, row_index=28, title="FFXIV", visible=False),
                
                "Linked": BoneCollection(name="Linked", ui=True, color_set="Torso_Tweak", row_index=29, title="XIV", visible=False),
                "Unlinked": BoneCollection(name="Unlinked", ui=True, color_set="IVCS", row_index=29, title="-EX", visible=False),

                "LINK": BoneCollection(name="LINK", ui=True,color_set="Torso",row_index=30, title="LINK", visible=False),
                "MCH": BoneCollection(name="MCH", ui=True,  row_index=30, title="MCH", visible=False),
                "DEF": BoneCollection(name="DEF", ui=True,  row_index=30, title="DEF", visible=False),
                "ORG": BoneCollection(name="ORG", ui=True,row_index=30, title="ORG", visible=False)
