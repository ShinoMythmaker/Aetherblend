...
UI_LINKS: dict[str, UILink] = {
    ...
    "Eye Lid Edit Mode": UILink(
        ...
        white_list=["lid.anchor.B.L.001","lid.anchor.B.L.002","lid.anchor.B.L.003","lid.anchor.B.R.001","lid.anchor.B.R.002","lid.anchor.B.R.003", "lid.B.R", "lid.B.L","lid.B.L.001", "lid.B.L.002", "lid.B.R.001", "lid.B.R.002", "lid.T.L", "lid.T.R", "lid.T.L.001", "lid.T.L.002", "lid.T.R.001", "lid.T.R.002", "lid.T.R.003", "lid.B.R.003", "lid.T.L.003", "lid.B.L.003", "Lid.Ctrl"], 
